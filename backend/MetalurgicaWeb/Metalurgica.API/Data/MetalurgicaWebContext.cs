...
namespace Metalurgica.API.Data;

public partial class MetalurgicaWebContext : DbContext
{
    public MetalurgicaWebContext(DbContextOptions<MetalurgicaWebContext> options)
        : base(options)
    {
    }
